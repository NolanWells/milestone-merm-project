...
export default function Createreview(props: CreatereviewProps): ReactElement {
    ...
    return (
        <div>
            ...
            <form action="/movies" method="POST">
                ...
                <br />
                <button className="button-79" style={{ position: "absolute", left: "34%", marginTop: "10%" }} type="submit">Submit</button>
            </form>
        </div>
    );
}